class EmployeesController < ApplicationController
  ...
  private
    ...
    def employee_params
      params.require(:employee).permit(:title, :empid, :firstname, :midname, :lastname, :bloodtype, :nationality, :address, :city, :state, :pin, :homenumber, :mobile, :email, :joined_at, :birth_date, :gender, :marital)
    end
end
